...
public class ParquetOutputBuffer
        //extends SliceOutput
{
//    private static final int INSTANCE_SIZE = ClassLayout.parseClass(ParquetOutputBuffer.class).instanceSize();
...
//
//    public ParquetOutputBuffer(int maxBufferSize)
//    {
