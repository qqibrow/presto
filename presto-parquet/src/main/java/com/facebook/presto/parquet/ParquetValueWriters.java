...
public class ParquetValueWriters
{
    ...
    public abstract static class PrimitiveWriter<T>
            implements ParquetValueWriter<T>
    {
        private final ColumnDescriptor desc;
        protected final com.facebook.presto.parquet.testwriter.ColumnWriter<T> column;
        private final List<TripleWriter<?>> children;

        protected PrimitiveWriter(ColumnDescriptor desc)
        {
            this.desc = desc;
            this.column = com.facebook.presto.parquet.testwriter.ColumnWriter.newWriter(desc);
    ...
    public abstract static class RepeatedWriter<L, E>
    ...
    public abstract static class RepeatedKeyValueWriter<M, K, V>
    ...
    public static class StructWriter<S>
