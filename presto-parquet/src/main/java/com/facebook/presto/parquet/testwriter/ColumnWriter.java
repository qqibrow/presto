package com.facebook.presto.parquet.testwriter;

import com.facebook.presto.parquet.TripleWriter;
...
public abstract class ColumnWriter<T> implements TripleWriter<T>
{
    ...
    public static <T> ColumnWriter<T> newWriter(ColumnDescriptor desc) {
        switch (desc.getType()) {
            case BOOLEAN:
